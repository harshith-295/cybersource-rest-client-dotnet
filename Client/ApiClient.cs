...
namespace CyberSource.Client
{
    ...
    public partial class ApiClient
    {
        ...
        //partial void InterceptResponse(IRestRequest request, RestResponse response);
            ...
            string contentType)
        {
            ...
            HttpWebRequest requestT = (HttpWebRequest)WebRequest.Create(Uri.EscapeUriString("https://" + RestClient.Options.BaseHost + path));
            ...
            string contentType)
        {
            ...
            //httpResponseHeaders = (IList<Parameter>)response.Headers;
            string httpResponseData = response.Content;
